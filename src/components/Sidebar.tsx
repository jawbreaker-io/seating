    ...
    <aside className="w-80 bg-white border-l border-gray-200 flex flex-col h-full">
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center gap-2 mb-3">
          <HiUserGroup className="text-gray-500 text-xl" />
        ...
        <div className="relative mb-2">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent"
          />
        </div>
      ...
      <div className="p-4 border-t border-gray-200 flex gap-2">
        <button
          ...
          onClick={onReset}
          className="flex-1 text-sm px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium"
        >
          Reset Default
        </button>
        <button
          ...
          onClick={onClear}
          className="flex-1 text-sm px-4 py-2.5 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors font-medium"
        >
          Clear All
        </button>
      </div>
