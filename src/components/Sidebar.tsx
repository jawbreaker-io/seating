    ...
    <aside className="w-72 bg-white border-l border-gray-200 flex flex-col h-full">
      <div className="p-4 border-b border-gray-200">
        ...
        <div className="relative mb-2">
          <HiSearch className="absolute left-2.5 top-2.5 text-gray-400 text-sm" />
          <input
            ...
            className="w-full pl-8 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent"
          />
        </div>
      ...
      <div className="p-4 border-t border-gray-200 flex gap-2">
        <button
          ...
          onClick={onReset}
          className="flex-1 text-xs px-3 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium"
        >
          Reset Default
        </button>
        <button
          ...
          onClick={onClear}
          className="flex-1 text-xs px-3 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors font-medium"
        >
          Clear All
        </button>
      </div>
