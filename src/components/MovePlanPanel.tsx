...
export function MovePlanPanel({
  ...
  return (
    ...
    >
      <motion.div
        className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-[580px] max-h-[85vh] flex flex-col overflow-hidden"
      ...
      >
        ...
        <div className="p-5 border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">Desk Move Planner</h2>
          </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`flex-1 p-4 rounded-xl border-2 border-dashed transition-all text-left ${
                originalFile
                  ...
                  : 'border-gray-200 hover:border-indigo-300 hover:bg-indigo-50/30 dark:border-gray-600 dark:hover:border-indigo-700 dark:hover:bg-indigo-900/20'
              }`}
            >
              <div className="flex items-center gap-2 mb-1">
                {originalFile ? (
                  <HiCheck className="text-green-500 dark:text-green-400 text-base" />
                ) : (
                  <HiUpload className="text-gray-400 dark:text-gray-500 text-base" />
                )}
                <span className={`text-sm font-semibold ${originalFile ? 'text-green-700 dark:text-green-400' : 'text-gray-700 dark:text-gray-200'}`}>
                  Current Layout
                </span>
              </div>
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className={`text-sm font-semibold ${newFile ? 'text-green-700 dark:text-green-400' : 'text-gray-700 dark:text-gray-200'}`}>
                  New Layout
                </span>
              </div>
              <p className="text-xs text-gray-500 dark:text-gray-400 truncate">
          ...
          <div className="px-5 pb-3">
            <div className="grid grid-cols-4 gap-2">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-2.5 text-center">
                <div className="text-lg font-bold text-gray-800 dark:text-gray-100">{movePlan.summary.totalSteps}</div>
                <div className="text-[10px] text-gray-500 dark:text-gray-400 font-medium">Total Steps</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-2.5 text-center">
                <div className="text-lg font-bold text-blue-600">{movePlan.summary.peopleMoving}</div>
                <div className="text-[10px] text-gray-500 dark:text-gray-400 font-medium">Desk Moves</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-2.5 text-center">
                <div className="text-lg font-bold text-amber-600">{movePlan.summary.cyclesDetected}</div>
                <div className="text-[10px] text-gray-500 dark:text-gray-400 font-medium">Cycles</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-2.5 text-center">
                <div className="text-lg font-bold text-green-600">{movePlan.summary.unchanged}</div>
                <div className="text-[10px] text-gray-500 dark:text-gray-400 font-medium">Unchanged</div>
              </div>
            </div>
          </div>
        )}
              ...
              <div className="space-y-1.5">
                ...
                {movePlan.steps.map((step, i) => {
                  ...
                  return (
                    ...
                    >
                      <span className="text-xs font-bold text-gray-400 dark:text-gray-500 w-6 text-right flex-shrink-0">
                        {step.step}.
                      </span>
                      <div
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="font-medium text-gray-700 dark:text-gray-200 truncate block">{step.employeeName}</span>
